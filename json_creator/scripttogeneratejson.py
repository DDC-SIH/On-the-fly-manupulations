...
def extract_tiff_metadata(tiff_file_path):
    ...
    return gdal.Info(tiff_file_path, format="json")
    ...
    for band_name, dataset_path in bands.items():
        ...
        try:
            ...
            gdal.Translate(
                georef_tif,
                output_tif,
                outputBounds=[georef_params["ulx"], georef_params["uly"], 
                             georef_params["lrx"], georef_params["lry"]],
            ...
            gdal.Translate(optimized_tif, webmercator_tif, 
                          creationOptions=optimized_params)
...
def main():
    ...
    try:
        process_files(input_file, bands, georef_params, 
                     webmercator_srs, optimized_params)
